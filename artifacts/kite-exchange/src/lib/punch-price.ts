...
const STORAGE_KEY = 'PUNCH_v2';
const CYCLE_MS    = 7 * 60 * 60 * 1000;
const MIN_PRICE   = 3.25;
const MAX_PRICE   = 4.12;
const INIT_VOL    = 1_500_000;
const MAX_VOL     = 35_000_000;
...
class PunchPriceManager {
  ...
  static getInstance(): PunchPriceManager {
    if (!PunchPriceManager.instance) PunchPriceManager.instance = new PunchPriceManager();
