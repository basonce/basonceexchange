...
export const BS_POSTS_POOL_V3: BinanceSquarePost[] = [
  ...
  // ── EQ posts ─────────────────────────────────────────────────────────────
  { content: "The most slept-on exchange token right now is $EQ 👀\nLow circulating supply, huge staking yield, and KITE's user base growing 40% month-on-month. This is a 10x candidate. Loaded my bags. NFA", tags: ['EQ','BNC'], sentiment: 'bullish', hasImage: false },
  { content: "Just realised $EQ holders get:\n✅ 40% of exchange fee revenue\n✅ Early access to IEO launchpad\n✅ Zero maker fees\n✅ Governance voting rights\n\nWhy aren't more people talking about this?!", tags: ['EQ'], sentiment: 'bullish', hasImage: false },
  { content: "My $EQ trade closed +2,840 USDT today 🟢\nEntry: $6.20 | Exit: $9.18 | Leverage: 10x\n\nKITE Exchange volume hit ATH yesterday. Token utility is real. Still early.", tags: ['EQ','BNC'], sentiment: 'bullish', hasImage: false },
  { content: "KITE Exchange fee burn just reduced $EQ supply by 2.3M tokens this week 🔥\n\nBurn mechanism + revenue share + growing user base = $EQ is the most asymmetric trade in crypto right now. Position: max", tags: ['EQ'], sentiment: 'bullish', hasImage: false },
  { content: "Why $EQ will outperform $BNB this cycle:\n1. Smaller market cap (100x room)\n2. Higher staking yield (38% APR vs 4%)\n3. Aggressive buyback + burn\n4. KITE launchpad IEOs incoming\n\nThis is early BNB energy. NFA", tags: ['EQ','BNC','BNB'], sentiment: 'bullish', hasImage: false },
  { content: "Staking $EQ on KITE and collecting daily USDT rewards while the market sleeps 💤\n\nPassive income + price appreciation + IEO allocation rights = hardest working token in my portfolio rn", tags: ['EQ'], sentiment: 'bullish', hasImage: false },
  { content: "$EQ technical setup looking insane right now 📈\nBroke ATH resistance, retested as support, volume surge confirmed. Next target: $14.50. If KITE volume stays above $800M daily, this is a lock. NOT financial advice", tags: ['EQ','BTC'], sentiment: 'bullish', hasImage: false },
  { content: "The $EQ/USDT chart is forming the most beautiful cup & handle pattern I've seen all year 🏆\n\nTarget: 3.2x from here. Time horizon: 3–6 months.\nRisk: exchange token market risk\nPosition size: substantial. NFA", tags: ['EQ'], sentiment: 'bullish', hasImage: false },

  // ── BNC posts ────────────────────────────────────────────────────────────
  { content: "$BNC is the reserve currency of KITE Exchange 👑\n\nAll trading fees paid in $BNC get burned. Daily volume: $1.2B. At current burn rate, 15% of supply is gone by end of year. Deflationary asset with real demand.", tags: ['BNC','EQ'], sentiment: 'bullish', hasImage: false },
  { content: "Just made +4,190 USDT on $BNC futures today 🟢\nEntry: $9.80 | Mark: $14.20 | 20x Cross\n\nKITE just announced institutional custody partnership. $BNC pumping on real news, not hype.", tags: ['BNC'], sentiment: 'bullish', hasImage: false },
  { content: "Three reasons I'm going all-in on $BNC this cycle:\n\n🔥 Token burn accelerating with volume growth\n🏦 Institutional on-ramp launching Q2\n📊 Only 8M circulating supply\n\nCombine all 3 = supply shock incoming. NFA", tags: ['BNC','EQ'], sentiment: 'bullish', hasImage: false },
  { content: "$BNC staking just hit 62% of total supply locked 📊\n\nEffective circulating supply is now tiny. Any buy pressure = massive price impact. This is BNB at $5 energy. I'm not selling for months.", tags: ['BNC'], sentiment: 'bullish', hasImage: false },
  { content: "KITE Exchange monthly stats just dropped 📈\n\n• $47B total volume\n• 2.1M active traders\n• $BNC burn: 1.4M tokens\n\nExchange utility creating real deflationary pressure on $BNC. Still early stages.", tags: ['BNC','EQ'], sentiment: 'bullish', hasImage: false },
  { content: "The $BNC launchpad IEOs are printing money for early investors 💰\n\nLast 3 IEOs: +340%, +180%, +720% ROI at peak\n\nHolding $BNC = guaranteed launchpad allocation. The game theory is perfect. NFA", tags: ['BNC'], sentiment: 'bullish', hasImage: false },
  { content: "People sleeping on $BNC are going to regret it just like they regret missing $BNB at $1 😤\n\nSame playbook: exchange growth → fee burn → supply crunch → price explosion\n\nDifferent exchange, same result. NFA", tags: ['BNC','BNB','EQ'], sentiment: 'bullish', hasImage: false },
  { content: "$BNC chart broke out of 8-month consolidation zone with 4x average volume 🚀\n\nOn-chain: whale wallets accumulated 12M tokens in past 2 weeks quietly. Something big is coming. My target: $28. NFA", tags: ['BNC','BTC'], sentiment: 'bullish', hasImage: false },
];
