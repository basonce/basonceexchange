...
export const TRADFI_ASSETS: TradFiAsset[] = [
  ...
  { symbol: 'TSLAUSDT',   displayName: 'TSLA',   category: 'Stock',     basePrice: 270.00,   volatility: 0.0012, volume24hBase: 187_340_000, logoUrl: 'https://assets.parqet.com/logos/symbol/TSLA?format=jpg' },
  { symbol: 'AAPLUSDT',   displayName: 'AAPL',   category: 'Stock',     basePrice: 220.00,   volatility: 0.0008, volume24hBase: 243_180_000, logoUrl: 'https://assets.parqet.com/logos/symbol/AAPL?format=jpg' },
  { symbol: 'AMZNUSDT',   displayName: 'AMZN',   category: 'Stock',     basePrice: 195.00,   volatility: 0.001,  volume24hBase: 156_720_000, logoUrl: 'https://assets.parqet.com/logos/symbol/AMZN?format=jpg' },
  { symbol: 'MSTRUSDT',   displayName: 'MSTR',   category: 'Stock',     basePrice: 320.00,   volatility: 0.0018, volume24hBase:  98_450_000, logoUrl: 'https://assets.parqet.com/logos/symbol/MSTR?format=jpg' },
  { symbol: 'HOODUSDT',   displayName: 'HOOD',   category: 'Stock',     basePrice: 45.00,    volatility: 0.0015, volume24hBase:  44_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/HOOD?format=jpg' },
  { symbol: 'INTCUSDT',   displayName: 'INTC',   category: 'Stock',     basePrice: 23.00,    volatility: 0.0012, volume24hBase:  67_890_000, logoUrl: 'https://assets.parqet.com/logos/symbol/INTC?format=jpg' },
  { symbol: 'CRCLUSDT',   displayName: 'CRCL',   category: 'Stock',     basePrice: 31.00,    volatility: 0.0012, volume24hBase:  83_150_000, logoUrl: 'https://financialmodelingprep.com/image-stock/CRCL.png' },
  { symbol: 'COINUSDT',   displayName: 'COIN',   category: 'Stock',     basePrice: 210.00,   volatility: 0.0013, volume24hBase: 127_600_000, logoUrl: 'https://assets.parqet.com/logos/symbol/COIN?format=jpg' },
  { symbol: 'PLTRUSDT',   displayName: 'PLTR',   category: 'Stock',     basePrice: 95.00,    volatility: 0.001,  volume24hBase:  72_340_000, logoUrl: 'https://assets.parqet.com/logos/symbol/PLTR?format=jpg' },
  { symbol: 'NVIDAUSDT',  displayName: 'NVDA',   category: 'Stock',     basePrice: 118.00,   volatility: 0.0012, volume24hBase: 218_900_000, logoUrl: 'https://assets.parqet.com/logos/symbol/NVDA?format=jpg' },
  { symbol: 'GOOGLUSDT',  displayName: 'GOOGL',  category: 'Stock',     basePrice: 170.00,   volatility: 0.0009, volume24hBase: 165_430_000, logoUrl: 'https://assets.parqet.com/logos/symbol/GOOGL?format=jpg' },
  { symbol: 'METAUSDT',   displayName: 'META',   category: 'Stock',     basePrice: 590.00,   volatility: 0.001,  volume24hBase: 195_780_000, logoUrl: 'https://assets.parqet.com/logos/symbol/META?format=jpg' },
  { symbol: 'MSFTUSDT',   displayName: 'MSFT',   category: 'Stock',     basePrice: 395.00,   volatility: 0.0008, volume24hBase: 234_560_000, logoUrl: 'https://assets.parqet.com/logos/symbol/MSFT?format=jpg' },
  { symbol: 'AMDUSDT',    displayName: 'AMD',    category: 'Stock',     basePrice: 110.00,   volatility: 0.0014, volume24hBase: 143_290_000, logoUrl: 'https://assets.parqet.com/logos/symbol/AMD?format=jpg' },
  { symbol: 'NFLXUSDT',   displayName: 'NFLX',   category: 'Stock',     basePrice: 1000.00,  volatility: 0.0011, volume24hBase:  89_670_000, logoUrl: 'https://assets.parqet.com/logos/symbol/NFLX?format=jpg' },
  { symbol: 'DISNUSDT',   displayName: 'DIS',    category: 'Stock',     basePrice: 102.00,   volatility: 0.001,  volume24hBase:  55_430_000, logoUrl: 'https://assets.parqet.com/logos/symbol/DIS?format=jpg' },
  { symbol: 'JPMUSDT',    displayName: 'JPM',    category: 'Stock',     basePrice: 240.00,   volatility: 0.0009, volume24hBase: 137_890_000, logoUrl: 'https://assets.parqet.com/logos/symbol/JPM?format=jpg' },
  { symbol: 'BACUSDT',    displayName: 'BAC',    category: 'Stock',     basePrice: 42.00,    volatility: 0.0010, volume24hBase:  76_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/BAC?format=jpg' },
  { symbol: 'GSUSDT',     displayName: 'GS',     category: 'Stock',     basePrice: 530.00,   volatility: 0.0009, volume24hBase:  51_780_000, logoUrl: 'https://assets.parqet.com/logos/symbol/GS?format=jpg' },
  { symbol: 'BRKBUSDT',   displayName: 'BRK.B',  category: 'Stock',     basePrice: 470.00,   volatility: 0.0007, volume24hBase:  93_450_000, logoUrl: 'https://assets.parqet.com/logos/symbol/BRK-B?format=jpg' },
  { symbol: 'VISAUSDT',   displayName: 'V',      category: 'Stock',     basePrice: 345.00,   volatility: 0.0008, volume24hBase: 108_670_000, logoUrl: 'https://assets.parqet.com/logos/symbol/V?format=jpg' },
  { symbol: 'MAUSDT',     displayName: 'MA',     category: 'Stock',     basePrice: 550.00,   volatility: 0.0008, volume24hBase:  82_340_000, logoUrl: 'https://assets.parqet.com/logos/symbol/MA?format=jpg' },
  { symbol: 'UBERUSDT',   displayName: 'UBER',   category: 'Stock',     basePrice: 82.00,    volatility: 0.0013, volume24hBase:  61_890_000, logoUrl: 'https://assets.parqet.com/logos/symbol/UBER?format=jpg' },
  { symbol: 'SPOTUSDT',   displayName: 'SPOT',   category: 'Stock',     basePrice: 595.00,   volatility: 0.0012, volume24hBase:  48_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/SPOT?format=jpg' },
  { symbol: 'SNAPUSDT',   displayName: 'SNAP',   category: 'Stock',     basePrice: 9.00,     volatility: 0.0016, volume24hBase:  36_780_000, logoUrl: 'https://assets.parqet.com/logos/symbol/SNAP?format=jpg' },
  { symbol: 'JNJUSDT',    displayName: 'JNJ',    category: 'Stock',     basePrice: 158.00,   volatility: 0.0007, volume24hBase: 114_560_000, logoUrl: 'https://assets.parqet.com/logos/symbol/JNJ?format=jpg' },
  { symbol: 'WMTUSDT',    displayName: 'WMT',    category: 'Stock',     basePrice: 98.00,    volatility: 0.0007, volume24hBase: 133_210_000, logoUrl: 'https://assets.parqet.com/logos/symbol/WMT?format=jpg' },
  { symbol: 'XOMUSDT',    displayName: 'XOM',    category: 'Stock',     basePrice: 115.00,   volatility: 0.0009, volume24hBase:  97_450_000, logoUrl: 'https://assets.parqet.com/logos/symbol/XOM?format=jpg' },
  { symbol: 'KOUSDT',     displayName: 'KO',     category: 'Stock',     basePrice: 70.00,    volatility: 0.0006, volume24hBase:  71_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/KO?format=jpg' },
  { symbol: 'PFEUSDT',    displayName: 'PFE',    category: 'Stock',     basePrice: 26.00,    volatility: 0.0009, volume24hBase:  88_670_000, logoUrl: 'https://assets.parqet.com/logos/symbol/PFE?format=jpg' },
  { symbol: 'SAPUSDT',    displayName: 'SAP',    category: 'Stock',     basePrice: 255.00,   volatility: 0.0008, volume24hBase:  56_340_000, logoUrl: 'https://assets.parqet.com/logos/symbol/SAP?format=jpg' },
  { symbol: 'ASMUSDT',    displayName: 'ASML',   category: 'Stock',     basePrice: 710.00,   volatility: 0.0011, volume24hBase:  64_890_000, logoUrl: 'https://assets.parqet.com/logos/symbol/ASML?format=jpg' },
  { symbol: 'NESNUSDT',   displayName: 'NESN',   category: 'Stock',     basePrice: 88.00,    volatility: 0.0006, volume24hBase:  43_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/NSRGY?format=jpg' },
  { symbol: 'LVMHUSDT',   displayName: 'LVMH',   category: 'Stock',     basePrice: 580.00,   volatility: 0.001,  volume24hBase:  38_780_000, logoUrl: 'https://assets.parqet.com/logos/symbol/LVMHF?format=jpg' },
  { symbol: 'TMUSDT',     displayName: 'TM',     category: 'Stock',     basePrice: 178.00,   volatility: 0.0008, volume24hBase:  53_450_000, logoUrl: 'https://assets.parqet.com/logos/symbol/TM?format=jpg' },
  { symbol: 'TSMUSDT',    displayName: 'TSM',    category: 'Stock',     basePrice: 180.00,   volatility: 0.001,  volume24hBase: 119_670_000, logoUrl: 'https://assets.parqet.com/logos/symbol/TSM?format=jpg' },
  { symbol: 'BABAUSDT',   displayName: 'BABA',   category: 'Stock',     basePrice: 115.00,   volatility: 0.0014, volume24hBase: 102_230_000, logoUrl: 'https://assets.parqet.com/logos/symbol/BABA?format=jpg' },
  { symbol: 'NVOUSDT',    displayName: 'NVO',    category: 'Stock',     basePrice: 78.00,    volatility: 0.001,  volume24hBase:  41_890_000, logoUrl: 'https://assets.parqet.com/logos/symbol/NVO?format=jpg' },
