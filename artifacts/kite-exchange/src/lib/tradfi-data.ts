...
export const TRADFI_ASSETS: TradFiAsset[] = [
  ...
  { symbol: 'SUGARUSDT',  displayName: 'SUGAR',  category: 'Commodity', basePrice: 20.50,    volatility: 0.0011, volume24hBase: 1500000,   logoUrl: 'sprite:sugar',  bgColor: '#1a1020' },
  { symbol: 'WHEATUSDT',  displayName: 'WHEAT',  category: 'Commodity', basePrice: 545.00,   volatility: 0.001,  volume24hBase: 1800000,   logoUrl: 'sprite:wheat',   bgColor: '#2a1a04' },
  { symbol: 'CORNUSDT',   displayName: 'CORN',   category: 'Commodity', basePrice: 455.00,   volatility: 0.001,  volume24hBase: 1600000,   logoUrl: 'sprite:corn',    bgColor: '#2a1a00' },
  { symbol: 'SOYUSDT',    displayName: 'SOYBEAN',category: 'Commodity', basePrice: 1050.00,  volatility: 0.0011, volume24hBase: 1300000,   logoUrl: 'sprite:soybean', bgColor: '#0a1a08' },

  // Agriculture (fallback prices)
  { symbol: 'LUMBERUSDT', displayName: 'LUMBER',  category: 'Agriculture', basePrice: 570.00,  volatility: 0.0012, volume24hBase: 820000,    logoUrl: '', bgColor: '#7c3a0a' },
  { symbol: 'FCATTLEUSDT',displayName: 'FCATTLE', category: 'Agriculture', basePrice: 280.00,  volatility: 0.0009, volume24hBase: 590000,    logoUrl: '', bgColor: '#5c3a0a' },
  ...
  { symbol: 'SP500USDT',  displayName: 'SPX',    category: 'Index',     basePrice: 6556.00,  volatility: 0.0005, volume24hBase: 95000000,  logoUrl: 'sprite:sp500',  bgColor: '#001a3a' },
  { symbol: 'NAS100USDT', displayName: 'NDX',    category: 'Index',     basePrice: 24002.00, volatility: 0.0006, volume24hBase: 78000000,  logoUrl: 'sprite:nas100', bgColor: '#001a3a' },
  { symbol: 'DJIA30USDT', displayName: 'DJI',    category: 'Index',     basePrice: 46124.00, volatility: 0.0004, volume24hBase: 52000000,  logoUrl: 'sprite:djia30', bgColor: '#001a3a' },
