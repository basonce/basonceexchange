...
const FINANCIAL_RESPONSES_TR = {
  ...
  deposit_general: 'Para yatırmak için Assets > Deposit bölümüne gidin. Coin olarak USDT, ağ olarak TRC20 (TRON) veya BEP20 (BSC) seçin, ekrandaki adresi kopyalayıp o adrese gönderin. Minimum 10 USDT, 5-30 dakika içinde onaylanır.',
  ...
  mining_general: 'Mining bölümünden ekipman alarak EQ token kazanırsınız. CPU Miner Pro ücretsizdir (5s/gün). Ücretli skala: GPU Miner Pro $150 (~$125/gün), GPU MAX $350 (~$200/gün), ASIC Miner Pro $400 (~$237/gün), Mining Farm $1.000 (~$470/gün), Industrial $2.500 (~$995/gün), Quantum $5.000 (~$1.642/gün). Her seviye 1-3 günde EQ→USDT swap\'ından kendini öder.',
...
const FINANCIAL_RESPONSES_EN = {
  ...
  deposit_general: 'To deposit, go to Assets > Deposit. Select coin USDT and network TRC20 (TRON) or BEP20 (BSC), copy the on-screen address and send. Minimum 10 USDT, confirms in 5-30 minutes.',
  ...
  mining_general: 'Purchase equipment in the Mining section to earn EQ tokens. CPU Miner Pro is free (5h/day). Paid catalog: GPU Miner Pro $150 (~$125/day), GPU MAX $350 (~$200/day), ASIC Miner Pro $400 (~$237/day), Mining Farm $1,000 (~$470/day), Industrial $2,500 (~$995/day), Quantum $5,000 (~$1,642/day). Each tier pays back in 1-3 days from EQ→USDT swaps.',
...
function getPersonalizedFinancialResponse(
  ...
  if (isSwap || isMining) {
    ...
    if (isSwap) {
      ...
      if (activeRigs === 0) {
        smartLine = tt(
          `⛏️ You have no active rigs yet. Start <b>free</b>: Mining > Equipment → activate <b>CPU Miner Pro</b> (0 cost, 5-hour daily session). To earn real USDT, the equipment ladder is: <b>GPU Miner Pro $150</b> (~$125/day, 48h), <b>GPU MAX $350</b> (~$200/day, 72h), <b>ASIC Miner Pro $400</b> (~$237/day, 72h), <b>Mining Farm $1,000</b> (~$470/day, 96h), <b>Industrial Station $2,500</b> (~$995/day, 120h), <b>Quantum Datacenter $5,000</b> (~$1,642/day, 168h). Every tier pays back in 1-3 days from EQ→USDT swaps.`,
          `⛏️ Aktif ekipmanınız yok. <b>Ücretsiz</b> başlayın: Mining > Equipment → <b>CPU Miner Pro</b>'yu aktive edin (bedava, günlük 5 saat). Gerçek USDT için ekipman skalası: <b>GPU Miner Pro $150</b> (~$125/gün, 48s), <b>GPU MAX $350</b> (~$200/gün, 72s), <b>ASIC Miner Pro $400</b> (~$237/gün, 72s), <b>Mining Farm $1.000</b> (~$470/gün, 96s), <b>Industrial Station $2.500</b> (~$995/gün, 120s), <b>Quantum Datacenter $5.000</b> (~$1.642/gün, 168s). Her seviye 1-3 günde EQ→USDT swap'ından kendini öder.`,
          `⛏️ Sin equipos activos. Empieza <b>gratis</b>: Mining > Equipment → activa <b>CPU Miner Pro</b> (sesión diaria 5h). Escalera de equipos: <b>GPU Miner Pro $150</b> (~$125/día, 48h), <b>GPU MAX $350</b> (~$200/día, 72h), <b>ASIC Pro $400</b> (~$237/día, 72h), <b>Mining Farm $1.000</b> (~$470/día, 96h), <b>Industrial $2.500</b> (~$995/día, 120h), <b>Quantum $5.000</b> (~$1.642/día, 168h). Cada nivel se paga solo en 1-3 días vía swap EQ→USDT.`,
          `⛏️ Aucun équipement actif. Démarrez <b>gratuitement</b> : Mining > Equipment → activez <b>CPU Miner Pro</b> (session 5h/jour). Échelle d'équipements : <b>GPU Miner Pro 150 $</b> (~125 $/j, 48h), <b>GPU MAX 350 $</b> (~200 $/j, 72h), <b>ASIC Pro 400 $</b> (~237 $/j, 72h), <b>Mining Farm 1 000 $</b> (~470 $/j, 96h), <b>Industrial 2 500 $</b> (~995 $/j, 120h), <b>Quantum 5 000 $</b> (~1 642 $/j, 168h). Chaque niveau se rentabilise en 1-3 jours via swap EQ→USDT.`,
          `⛏️ Keine aktiven Geräte. <b>Kostenlos</b> starten: Mining > Equipment → <b>CPU Miner Pro</b> aktivieren (5h täglich). Geräteleiter: <b>GPU Miner Pro 150 $</b> (~125 $/T, 48h), <b>GPU MAX 350 $</b> (~200 $/T, 72h), <b>ASIC Pro 400 $</b> (~237 $/T, 72h), <b>Mining Farm 1 000 $</b> (~470 $/T, 96h), <b>Industrial 2 500 $</b> (~995 $/T, 120h), <b>Quantum 5 000 $</b> (~1 642 $/T, 168h). Jede Stufe amortisiert sich in 1-3 Tagen via EQ→USDT-Swap.`,
          `⛏️ Нет активного оборудования. Начните <b>бесплатно</b>: Mining > Equipment → активируйте <b>CPU Miner Pro</b> (5ч/день). Лестница оборудования: <b>GPU Miner Pro $150</b> (~$125/день, 48ч), <b>GPU MAX $350</b> (~$200/день, 72ч), <b>ASIC Pro $400</b> (~$237/день, 72ч), <b>Mining Farm $1 000</b> (~$470/день, 96ч), <b>Industrial $2 500</b> (~$995/день, 120ч), <b>Quantum $5 000</b> (~$1 642/день, 168ч). Каждый уровень окупается за 1-3 дня через своп EQ→USDT.`,
          `⛏️ لا معدات نشطة. ابدأ <b>مجانًا</b>: Mining > Equipment → فعّل <b>CPU Miner Pro</b> (5 ساعات يوميًا). سلّم المعدات: <b>GPU Miner Pro $150</b> (~$125/يوم، 48س)، <b>GPU MAX $350</b> (~$200/يوم، 72س)، <b>ASIC Pro $400</b> (~$237/يوم، 72س)، <b>Mining Farm $1,000</b> (~$470/يوم، 96س)، <b>Industrial $2,500</b> (~$995/يوم، 120س)، <b>Quantum $5,000</b> (~$1,642/يوم، 168س). كل مستوى يسترد كلفته في 1-3 أيام عبر مبادلة EQ→USDT.`,
          `⛏️ 暂无活跃设备。<b>免费</b>开始：Mining > Equipment → 激活 <b>CPU Miner Pro</b>（每日 5 小时）。设备阶梯：<b>GPU Miner Pro $150</b>（~$125/天，48h）、<b>GPU MAX $350</b>（~$200/天，72h）、<b>ASIC Pro $400</b>（~$237/天，72h）、<b>Mining Farm $1,000</b>（~$470/天，96h）、<b>Industrial $2,500</b>（~$995/天，120h）、<b>Quantum $5,000</b>（~$1,642/天，168h）。每档通过 EQ→USDT 兑换 1-3 天回本。`,
          `⛏️ Sem equipamentos ativos. Comece <b>grátis</b>: Mining > Equipment → ative <b>CPU Miner Pro</b> (5h/dia). Escada de equipamentos: <b>GPU Miner Pro $150</b> (~$125/dia, 48h), <b>GPU MAX $350</b> (~$200/dia, 72h), <b>ASIC Pro $400</b> (~$237/dia, 72h), <b>Mining Farm $1.000</b> (~$470/dia, 96h), <b>Industrial $2.500</b> (~$995/dia, 120h), <b>Quantum $5.000</b> (~$1.642/dia, 168h). Cada nível paga-se em 1-3 dias via swap EQ→USDT.`
        );
      } else if (hasUsdt) {
        smartLine = tt(
          `⛏️ You have ${activeRigs} active rig${activeRigs > 1 ? 's' : ''} and enough USDT to upgrade. Real catalog: <b>GPU Miner Pro $150</b> (~$125/day), <b>GPU MAX $350</b> (~$200/day), <b>ASIC Miner Pro $400</b> (~$237/day), <b>Mining Farm $1,000</b> (~$470/day), <b>Industrial $2,500</b> (~$995/day), <b>Quantum $5,000</b> (~$1,642/day). Stack rigs to multiply daily EQ. Mining > Equipment.`,
          `⛏️ ${activeRigs} aktif ekipmanınız var ve yükseltmek için yeterli USDT'niz var. Gerçek katalog: <b>GPU Miner Pro $150</b> (~$125/gün), <b>GPU MAX $350</b> (~$200/gün), <b>ASIC Miner Pro $400</b> (~$237/gün), <b>Mining Farm $1.000</b> (~$470/gün), <b>Industrial $2.500</b> (~$995/gün), <b>Quantum $5.000</b> (~$1.642/gün). Ekipmanları üst üste koyup günlük EQ'yu katlayın. Mining > Equipment.`,
          `⛏️ Tienes ${activeRigs} equipo(s) y USDT suficiente. Catálogo real: <b>GPU Miner Pro $150</b> (~$125/día), <b>GPU MAX $350</b> (~$200/día), <b>ASIC Pro $400</b> (~$237/día), <b>Mining Farm $1.000</b> (~$470/día), <b>Industrial $2.500</b> (~$995/día), <b>Quantum $5.000</b> (~$1.642/día). Apila equipos para multiplicar EQ diario. Mining > Equipment.`,
          `⛏️ Vous avez ${activeRigs} équipement(s) et assez d'USDT. Catalogue réel : <b>GPU Miner Pro 150 $</b> (~125 $/j), <b>GPU MAX 350 $</b> (~200 $/j), <b>ASIC Pro 400 $</b> (~237 $/j), <b>Mining Farm 1 000 $</b> (~470 $/j), <b>Industrial 2 500 $</b> (~995 $/j), <b>Quantum 5 000 $</b> (~1 642 $/j). Empilez pour multiplier l'EQ quotidien. Mining > Equipment.`,
          `⛏️ ${activeRigs} aktive Geräte und genug USDT. Echter Katalog: <b>GPU Miner Pro 150 $</b> (~125 $/T), <b>GPU MAX 350 $</b> (~200 $/T), <b>ASIC Pro 400 $</b> (~237 $/T), <b>Mining Farm 1 000 $</b> (~470 $/T), <b>Industrial 2 500 $</b> (~995 $/T), <b>Quantum 5 000 $</b> (~1 642 $/T). Stapeln Sie Geräte für mehr tägliches EQ. Mining > Equipment.`,
          `⛏️ У вас ${activeRigs} активн. оборуд. и достаточно USDT. Реальный каталог: <b>GPU Miner Pro $150</b> (~$125/день), <b>GPU MAX $350</b> (~$200/день), <b>ASIC Pro $400</b> (~$237/день), <b>Mining Farm $1 000</b> (~$470/день), <b>Industrial $2 500</b> (~$995/день), <b>Quantum $5 000</b> (~$1 642/день). Добавляйте оборуд. для × EQ. Mining > Equipment.`,
          `⛏️ لديك ${activeRigs} معدات نشطة وUSDT كافٍ. الكتالوج الحقيقي: <b>GPU Miner Pro $150</b> (~$125/يوم)، <b>GPU MAX $350</b> (~$200/يوم)، <b>ASIC Pro $400</b> (~$237/يوم)، <b>Mining Farm $1,000</b> (~$470/يوم)، <b>Industrial $2,500</b> (~$995/يوم)، <b>Quantum $5,000</b> (~$1,642/يوم). راكم المعدات لمضاعفة EQ. Mining > Equipment.`,
          `⛏️ 您有 ${activeRigs} 台活跃设备和足够 USDT。真实目录：<b>GPU Miner Pro $150</b>（~$125/天）、<b>GPU MAX $350</b>（~$200/天）、<b>ASIC Pro $400</b>（~$237/天）、<b>Mining Farm $1,000</b>（~$470/天）、<b>Industrial $2,500</b>（~$995/天）、<b>Quantum $5,000</b>（~$1,642/天）。叠加设备倍增每日 EQ。Mining > Equipment.`,
          `⛏️ Você tem ${activeRigs} equipamento(s) e USDT suficiente. Catálogo real: <b>GPU Miner Pro $150</b> (~$125/dia), <b>GPU MAX $350</b> (~$200/dia), <b>ASIC Pro $400</b> (~$237/dia), <b>Mining Farm $1.000</b> (~$470/dia), <b>Industrial $2.500</b> (~$995/dia), <b>Quantum $5.000</b> (~$1.642/dia). Empilhe equipamentos para multiplicar EQ diário. Mining > Equipment.`
        );
      } else {
        smartLine = tt(
          `⛏️ You have ${activeRigs} active rig${activeRigs > 1 ? 's' : ''} mining slowly. To boost daily EQ, top up USDT and choose your tier — entry <b>GPU Miner Pro $150</b> (~$125/day, ROI 1-2 days), <b>GPU MAX $350</b> (~$200/day), <b>ASIC Pro $400</b> (~$237/day), <b>Mining Farm $1,000</b> (~$470/day), <b>Industrial $2,500</b> (~$995/day), <b>Quantum $5,000</b> (~$1,642/day). Each tier pays itself back in 1-3 days from EQ→USDT swaps.`,
          `⛏️ ${activeRigs} aktif ekipmanınız yavaş kazıyor. Günlük EQ'yu artırmak için USDT yatırıp seviye seçin — giriş <b>GPU Miner Pro $150</b> (~$125/gün, 1-2 günde geri öder), <b>GPU MAX $350</b> (~$200/gün), <b>ASIC Pro $400</b> (~$237/gün), <b>Mining Farm $1.000</b> (~$470/gün), <b>Industrial $2.500</b> (~$995/gün), <b>Quantum $5.000</b> (~$1.642/gün). Her seviye 1-3 günde EQ→USDT swap'larından kendini öder.`,
          `⛏️ Tienes ${activeRigs} equipo(s) lentos. Para más EQ diario, recarga USDT y elige nivel — entrada <b>GPU Miner Pro $150</b> (~$125/día, ROI 1-2 días), <b>GPU MAX $350</b>, <b>ASIC $400</b>, <b>Mining Farm $1.000</b>, <b>Industrial $2.500</b>, <b>Quantum $5.000</b>. Cada nivel se paga en 1-3 días vía swap EQ→USDT.`,
          `⛏️ Vous avez ${activeRigs} équipement(s) lents. Pour plus d'EQ/jour, rechargez USDT et choisissez : entrée <b>GPU Miner Pro 150 $</b> (~125 $/j, ROI 1-2 j), <b>GPU MAX 350 $</b>, <b>ASIC 400 $</b>, <b>Mining Farm 1 000 $</b>, <b>Industrial 2 500 $</b>, <b>Quantum 5 000 $</b>. Rentables en 1-3 jours via swap EQ→USDT.`,
          `⛏️ ${activeRigs} langsame Geräte. Für mehr tägliches EQ USDT aufladen und Stufe wählen — Einstieg <b>GPU Miner Pro 150 $</b> (~125 $/T, ROI 1-2 T), <b>GPU MAX 350 $</b>, <b>ASIC 400 $</b>, <b>Mining Farm 1 000 $</b>, <b>Industrial 2 500 $</b>, <b>Quantum 5 000 $</b>. Amortisation 1-3 Tage via EQ→USDT-Swap.`,
          `⛏️ ${activeRigs} медленных оборуд. Пополните USDT и выберите уровень — старт <b>GPU Miner Pro $150</b> (~$125/день, ROI 1-2 дня), <b>GPU MAX $350</b>, <b>ASIC $400</b>, <b>Mining Farm $1 000</b>, <b>Industrial $2 500</b>, <b>Quantum $5 000</b>. Окупаемость 1-3 дня через своп EQ→USDT.`,
          `⛏️ ${activeRigs} معدات بطيئة. اشحن USDT واختر مستوى — البداية <b>GPU Miner Pro $150</b> (~$125/يوم، استرداد 1-2 يوم)، <b>GPU MAX $350</b>، <b>ASIC $400</b>، <b>Mining Farm $1,000</b>، <b>Industrial $2,500</b>، <b>Quantum $5,000</b>. كل مستوى يسترد كلفته في 1-3 أيام عبر مبادلة EQ→USDT.`,
          `⛏️ ${activeRigs} 台慢速设备。充值 USDT 并选择档位 — 入门 <b>GPU Miner Pro $150</b>（~$125/天，1-2 天回本）、<b>GPU MAX $350</b>、<b>ASIC $400</b>、<b>Mining Farm $1,000</b>、<b>Industrial $2,500</b>、<b>Quantum $5,000</b>。每档通过 EQ→USDT 兑换 1-3 天回本。`,
          `⛏️ ${activeRigs} equipamento(s) lentos. Recarregue USDT e escolha o nível — entrada <b>GPU Miner Pro $150</b> (~$125/dia, ROI 1-2 dias), <b>GPU MAX $350</b>, <b>ASIC $400</b>, <b>Mining Farm $1.000</b>, <b>Industrial $2.500</b>, <b>Quantum $5.000</b>. Cada nível paga-se em 1-3 dias via swap EQ→USDT.`
        );
      }
    }
