class SGPPriceManager {
  ...
  private price: number = 0.01;
  private change: number = 0;
  private high24h: number = 0.01068;
  private low24h: number = 0.00942;
  private marketCap: number = 7400000;
  ...
  private async fetchPriceFromServer() {
    try {
      ...
      const apiUrl = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/sgp-price-updater`;
      const headers = {
