...
const STORAGE_KEY = 'SGP_v2';
const CYCLE_MS    = 12 * 60 * 60 * 1000;
const MIN_PRICE   = 0.12;
const MAX_PRICE   = 0.79;
const INIT_VOL    = 1_000_000;
const MAX_VOL     = 28_000_000;
...
class SGPPriceManager {
  ...
  static getInstance(): SGPPriceManager {
    if (!SGPPriceManager.instance) SGPPriceManager.instance = new SGPPriceManager();
