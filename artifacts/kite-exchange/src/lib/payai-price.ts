...
const STORAGE_KEY = 'PAYAI_v2';
const CYCLE_MS    = 11 * 60 * 60 * 1000;
const MIN_PRICE   = 1.00;
const MAX_PRICE   = 2.78;
const INIT_VOL    = 1_500_000;
const MAX_VOL     = 38_000_000;
...
class PayAIPriceManager {
  ...
  static getInstance(): PayAIPriceManager {
    if (!PayAIPriceManager.instance) PayAIPriceManager.instance = new PayAIPriceManager();
