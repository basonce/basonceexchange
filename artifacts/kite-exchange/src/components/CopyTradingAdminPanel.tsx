        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Örn: 50"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-base font-bold text-gray-900 bg-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            />
