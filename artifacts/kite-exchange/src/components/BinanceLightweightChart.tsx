...
const METAL_CROSS_TRADFI: Record<string, string> = {
  ...
  COPPERBTC: 'COPPERUSDT', COPPERETH: 'COPPERUSDT',
  OILBTC: 'WTIUSDT',     OILETH: 'WTIUSDT',
  BRTBTC: 'BRENTUSDT',   BRTETH: 'BRENTUSDT',
  NATGASBTC: 'NATGASUSDT', NATGASETH: 'NATGASUSDT',
  COFFEEBTC: 'COFFEEUSDT', COFFEEETH: 'COFFEEUSDT',
  COCOABTC: 'COCOAUSDT', COCOAETH: 'COCOAUSDT',
  SUGARBTC: 'SUGARUSDT',  SUGARETH: 'SUGARUSDT',
  WHEATBTC: 'WHEATUSDT',  WHEATETH: 'WHEATUSDT',
  CORNBTC: 'CORNUSDT',    CORNETH: 'CORNUSDT',
  SOYBEANBTC: 'SOYUSDT',  SOYBEANETH: 'SOYUSDT',
  SPXBTC: 'SP500USDT',    SPXETH: 'SP500USDT',
  NDXBTC: 'NAS100USDT',   NDXETH: 'NAS100USDT',
  DJIBTC: 'DJIA30USDT',   DJIETH: 'DJIA30USDT',
  DAXBTC: 'DAXUSDT',      DAXETH: 'DAXUSDT',
  FTSEBTC: 'FTSE100USDT', FTSEETH: 'FTSE100USDT',
  NKYBTC: 'NI225USDT',    NKYETH: 'NI225USDT',
};
...
const METAL_CROSS_QUOTE_COIN: Record<string, string> = {
  ...
  COPPERBTC: 'BTC',  COPPERETH: 'ETH',
  OILBTC: 'BTC',     OILETH: 'ETH',
  BRTBTC: 'BTC',     BRTETH: 'ETH',
  NATGASBTC: 'BTC',  NATGASETH: 'ETH',
  COFFEEBTC: 'BTC',  COFFEEETH: 'ETH',
  COCOABTC: 'BTC',   COCOAETH: 'ETH',
  SUGARBTC: 'BTC',   SUGARETH: 'ETH',
  WHEATBTC: 'BTC',   WHEATETH: 'ETH',
  CORNBTC: 'BTC',    CORNETH: 'ETH',
  SOYBEANBTC: 'BTC', SOYBEANETH: 'ETH',
  SPXBTC: 'BTC',     SPXETH: 'ETH',
  NDXBTC: 'BTC',     NDXETH: 'ETH',
  DJIBTC: 'BTC',     DJIETH: 'ETH',
  DAXBTC: 'BTC',     DAXETH: 'ETH',
  FTSEBTC: 'BTC',    FTSEETH: 'ETH',
  NKYBTC: 'BTC',     NKYETH: 'ETH',
};
