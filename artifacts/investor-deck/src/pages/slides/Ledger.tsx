      ...
      <div className="relative h-full w-full flex flex-col px-[8vw] py-[7vh]">
        ...
        <div className="grid grid-cols-4 gap-[1.6vw]">
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            ...
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">İki bacak</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Para bir hesaptan çıkar, diğerine girer; tek bacaklı kayıt imkânsızdır.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">02 · Sıfır fark</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Anlık mutabakat</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Defter ile canlı bakiyeler sürekli karşılaştırılır; hedef her an 0 fark.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">03 · Değişmez</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Silme yok</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Geçmiş kayıt asla silinmez; hata varsa bankacılıktaki gibi ters kayıtla düzeltilir.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">04 · İzlenebilir</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Tam geçmiş</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">"Bu bakiye neden bu?" sorusu ilk günden itibaren kayıtlarla yanıtlanır.</div>
          </div>
        </div>
