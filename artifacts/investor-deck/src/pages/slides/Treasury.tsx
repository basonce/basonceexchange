      ...
      <div className="relative h-full w-full flex flex-col px-[8vw] py-[7vh]">
        ...
        <div className="grid grid-cols-3 gap-[2vw]">
          <div className="bg-surface rounded-2xl px-[1.9vw] py-[3.4vh] border border-white/5">
            ...
            <div className="text-muted text-[1.15vw] leading-snug mt-[1.4vh]">Riskten geçen çekim kuyruğa düşer; yetkili onaylamadan tek kuruş çıkmaz.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.9vw] py-[3.4vh] border border-white/5">
            ...
            <div className="text-muted text-[1.15vw] leading-snug mt-[1.4vh]">Büyük tutarlar iki farklı kişinin onayını gerektirir; aynı kişi ikinci onayı veremez.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.9vw] py-[3.4vh] border border-white/5">
            ...
            <div className="text-muted text-[1.15vw] leading-snug mt-[1.4vh]">Fonların büyük kısmı internete kapalı soğuk cüzdanda; günlük işlem için küçük kısım sıcakta.</div>
          </div>
        </div>
