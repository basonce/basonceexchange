      ...
      <div className="relative h-full w-full flex flex-col px-[8vw] py-[7vh]">
        ...
        <div className="grid grid-cols-4 gap-[1.6vw]">
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            ...
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Günlük & haftalık</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Kullanıcı başına tutar limitleri; aşan işlem otomatik bekletilir.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">02 · Davranış</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Ani değişim</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Sık ardışık çekim veya alışılmadık tutar tespitinde işlem incelemeye alınır.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">03 · Yeni hesap</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Bekleme süresi</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Yeni açılan hesapların çekimleri ek kontrole tabidir.</div>
          </div>
          <div className="bg-surface rounded-2xl px-[1.6vw] py-[3.2vh] border border-white/5">
            <div className="font-display font-bold text-accent text-[1.6vw] mb-[1.2vh]">04 · Kara liste</div>
            <div className="text-text text-[1.3vw] font-display font-semibold leading-tight">Adres kontrolü</div>
            <div className="text-muted text-[1.05vw] leading-snug mt-[1vh]">Riskli adreslere çekim otomatik engellenir; liste anlık güncellenir.</div>
          </div>
        </div>
